...
def create_materials(enrich_Li, neutron_multi=0):
...
class ITERTokamak_mod(paramak.Reactor):
    ...
    from ITERTokamak function from paramak package v1.0"""
...
if __name__ == '__main__':
    ## BELUM SELESAI
    ## BELUM DITES DAN ARGUMENT PARSER MASIH BELUM SIAP
