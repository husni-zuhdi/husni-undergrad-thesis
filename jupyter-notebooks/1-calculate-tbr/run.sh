...
do
  ...
  do
    ...
    gsutil cp results.json gs://iter-tritium-breeding-xgboost-bucket/v3/results/$i-$mod-$nm-100-1000.json
    gsutil cp statepoint.100.h5 gs://iter-tritium-breeding-xgboost-bucket/v3/statepoint/$i-$mod-$nm-100-1000.h5
    gsutil cp tallies.out gs://iter-tritium-breeding-xgboost-bucket/v3/tallies/$i-$mod-$nm-100-1000.out
    gsutil cp n-Xt_on_3D_mesh.vtk gs://iter-tritium-breeding-xgboost-bucket/v3/3D-mesh/$i-$mod-$nm-100-1000.vtk
    gsutil cp n-Xt_on_2D_mesh_xy.png gs://iter-tritium-breeding-xgboost-bucket/v3/2D-mesh/xy/$i-$mod-$nm-100-1000.png
    gsutil cp n-Xt_on_2D_mesh_xz.png gs://iter-tritium-breeding-xgboost-bucket/v3/2D-mesh/xz/$i-$mod-$nm-100-1000.png
