...
do
  cd ~/iter-tritium-breeding-xgboost/jupyter-notebooks/1-calculate-tbr
  mkdir  "calculate_tbr/$i-0.1-0.3-100-1000"
  cp calculate_tbr.py "calculate_tbr/$i-0.1-0.3-100-1000/calculate_tbr.py"
  cd "calculate_tbr/$i-0.1-0.3-100-1000"
  echo "Start simulating $i Li-6 enrichment + 0.1 Mod Ratio + 0.3 Neutron Multiplier Ratio"
  python calculate_tbr.py --enrich_Li $i --mod_ratio 0.1 \
  --neutron_multi 0.3 --batch 100 --part_batch 1000
